...
turtle.pencolor("black")
turtle.goto(-42, -160)
turtle.write("HoC 2022", font=('Arial', 15, 'bold italic'))
turtle.hideturtle()

turtle.done()

#Original code: 来源：Crossin的编程教室
#https://github.com/crossin/snippet/blob/master/BingDwenDwen/BingDwenDwen.py
